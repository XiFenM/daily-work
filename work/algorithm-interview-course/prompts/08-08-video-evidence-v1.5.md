...
- 课次 ID：`08-08`
- 章节：`08 递归和回溯法`
- 目录原始标题：`回溯法是经典人工智能的基础 N Queens`
- 目录规范标题：`回溯法是经典人工智能的基础 N Queens`
- 目录与 FFprobe 时长：`25:17（目录标称）；1521.96 秒（FFprobe）`
- **视频实测总时长：`1521.96` 秒，即 `1521960` 毫秒**
- 视频资产 ID：`asset:video-08-08`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-07",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-08"`；
- 所有时间戳不超过 `1521960`；
