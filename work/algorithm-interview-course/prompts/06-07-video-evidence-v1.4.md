...
- 课次 ID：`06-07`
- 章节：`06 栈，队列，优先队列`
- 目录原始标题：`优先队列相关的算法问题 Top K Frequent Elements`
- 目录规范标题：`优先队列相关的算法问题 Top K Frequent Elements`
- 目录与 FFprobe 时长：`15:37（目录标称）；941.685261 秒（FFprobe）`
- **视频实测总时长：`941.685261` 秒，即 `941685` 毫秒**
- 视频资产 ID：`asset:video-06-07`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "06-06",
    "title": "优先队列"
...
- 可核查的关系候选：`[
  {
    ...
    "fromTitle": "优先队列",
    "to": "lesson:06-07",
    "toTitle": "优先队列相关的算法问题 Top K Frequent Elements",
    "type": "applies",
    "status": "provisional",
  ...
  {
    "from": "lesson:06-07",
    "fromTitle": "优先队列相关的算法问题 Top K Frequent Elements",
    "to": "lesson:06-08",
    "toTitle": "两种关于 Top K 问题求解思路的套路",
    "type": "extends",
    "status": "provisional",
    "priorKind": "non_evidence_candidate_for_checking"
  }
...
"titleObserved": null,
"contentKind": "unknown",
"actualDurationSeconds": 941.685261,
"timeline": [],
"learningObjectives": [],
"concepts": [],
"problem": null,
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-06-07"`；
- 所有时间戳不超过 `941685`；
