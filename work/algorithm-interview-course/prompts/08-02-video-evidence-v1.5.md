...
- 目录原始标题：`什么是回溯`
- 目录规范标题：`什么是回溯`
- 目录与 FFprobe 时长：`18:16（目录标称）；1096.16 秒（FFprobe）`
- **视频实测总时长：`1096.16` 秒，即 `1096160` 毫秒**
- 视频资产 ID：`asset:video-08-02`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-01",
    "title": "树形问题 Letter Combinations of a Phone Number"
  },
  {
    "lessonId": "08-03",
    "title": "排列问题 Permutations"
  }
]`
- 可核查的关系候选：`[
  {
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-02"`；
- 所有时间戳不超过 `1096160`；
