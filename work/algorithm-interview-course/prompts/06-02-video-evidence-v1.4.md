...
- 课次 ID：`06-02`
- 章节：`06 栈，队列，优先队列`
- 目录原始标题：`栈和递归的紧密关系 Binary Tree Preorder, Inorder and Postorder Traversal`
- 目录规范标题：`栈和递归的紧密关系 Binary Tree Preorder, Inorder and Postorder Traversal`
- 目录与 FFprobe 时长：`16:03（目录标称）；963.68 秒（FFprobe）`
- **视频实测总时长：`963.68` 秒，即 `963680` 毫秒**
- 视频资产 ID：`asset:video-06-02`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "06-01",
    "title": "栈的基础应用 Valid Parentheses"
  },
  {
    "lessonId": "06-03",
    "title": "运用栈模拟递归"
...
- 可核查的关系候选：`[
  {
    "from": "lesson:02-05",
    "fromTitle": "递归算法的复杂度分析",
    "to": "lesson:06-02",
    "toTitle": "栈和递归的紧密关系 Binary Tree Preorder, Inorder and Postorder Traversal",
  ...
  {
    "from": "lesson:06-02",
    "fromTitle": "栈和递归的紧密关系 Binary Tree Preorder, Inorder and Postorder Traversal",
    "to": "lesson:06-03",
    "toTitle": "运用栈模拟递归",
    "type": "extends",
    "status": "provisional",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-06-02"`；
- 所有时间戳不超过 `963680`；
