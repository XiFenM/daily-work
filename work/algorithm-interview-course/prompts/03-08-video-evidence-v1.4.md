...
- 课次 ID：`03-08`
- 章节：`03 数组中的问题其实最常见`
- 目录原始标题：`在滑动窗口中做记录 Longest Substring Without Repeating Characters`
- 目录规范标题：`在滑动窗口中做记录 Longest Substring Without Repeating Characters`
- 目录与 FFprobe 时长：`15:20（目录标称）；924.68 秒（FFprobe）`
- **视频实测总时长：`924.68` 秒，即 `924680` 毫秒**
- 视频资产 ID：`asset:video-03-08`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "03-07",
    "title": "滑动窗口 Minimum Size Subarray Sum"
  }
]`
- 可核查的关系候选：`[
  {
    ...
    "to": "lesson:03-08",
    "toTitle": "在滑动窗口中做记录 Longest Substring Without Repeating Characters",
    "type": "same_problem_family_as",
    "status": "provisional",
    "priorKind": "non_evidence_candidate_for_checking"
  },
  {
    "from": "lesson:03-07",
    "fromTitle": "滑动窗口 Minimum Size Subarray Sum",
    "to": "lesson:03-08",
    "toTitle": "在滑动窗口中做记录 Longest Substring Without Repeating Characters",
    "type": "extends",
    "status": "provisional",
  ...
  {
    "from": "lesson:03-08",
    "fromTitle": "在滑动窗口中做记录 Longest Substring Without Repeating Characters",
    "to": "lesson:04-07",
    "toTitle": "查找表和滑动窗口 Contain Duplicate II",
    "type": "applies",
    "status": "provisional",
    "priorKind": "non_evidence_candidate_for_checking"
  }
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-03-08"`；
- 所有时间戳不超过 `924680`；
