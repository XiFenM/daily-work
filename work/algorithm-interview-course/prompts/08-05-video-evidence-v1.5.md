...
- 目录原始标题：`回溯法解决组合问题的优化`
- 目录规范标题：`回溯法解决组合问题的优化`
- 目录与 FFprobe 时长：`17:29（目录标称）；1049.08 秒（FFprobe）`
- **视频实测总时长：`1049.08` 秒，即 `1049080` 毫秒**
- 视频资产 ID：`asset:video-08-05`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-04",
    "title": "组合问题 Combinations"
  },
  {
    "lessonId": "08-06",
...
- 可核查的关系候选：`[
  {
    "from": "lesson:08-04",
    "fromTitle": "组合问题 Combinations",
    "to": "lesson:08-05",
    "toTitle": "回溯法解决组合问题的优化",
    "type": "extends",
    "status": "provisional",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-05"`；
- 所有时间戳不超过 `1049080`；
