...
- 课次 ID：`07-05`
- 章节：`07 二叉树和递归`
- 目录原始标题：`定义递归问题 Binary Tree Path`
- 目录规范标题：`定义递归问题 Binary Tree Path`
- 目录与 FFprobe 时长：`13:34（目录标称）；814.881088 秒（FFprobe）`
- **视频实测总时长：`814.881088` 秒，即 `814881` 毫秒**
- 视频资产 ID：`asset:video-07-05`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "07-04",
    "title": "注意递归的终止条件 Path Sum"
  },
  {
    "lessonId": "07-06",
    "title": "稍复杂的递归逻辑 Path Sum III"
  }
]`
- 可核查的关系候选：`[
  {
    "from": "lesson:07-04",
    "fromTitle": "注意递归的终止条件 Path Sum",
    "to": "lesson:07-05",
    "toTitle": "定义递归问题 Binary Tree Path",
    "type": "extends",
    "status": "provisional",
...
"titleObserved": null,
"contentKind": "unknown",
"actualDurationSeconds": 814.881088,
"timeline": [],
"learningObjectives": [],
"concepts": [],
"problem": null,
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-07-05"`；
- 所有时间戳不超过 `814881`；
