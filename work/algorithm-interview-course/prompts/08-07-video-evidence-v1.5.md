...
- 课次 ID：`08-07`
- 章节：`08 递归和回溯法`
- 目录原始标题：`floodfill算法，一类经典问题 Number of Islands-`
- 目录规范标题：`flood fill 算法，一类经典问题 Number of Islands`
- 目录与 FFprobe 时长：`21:27（目录标称）；1287.48 秒（FFprobe）`
- **视频实测总时长：`1287.48` 秒，即 `1287480` 毫秒**
- 视频资产 ID：`asset:video-08-07`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-06",
    "title": "二维平面上的回溯法 Word Search"
  },
  {
    "lessonId": "08-08",
    "title": "回溯法是经典人工智能的基础 N Queens"
  }
]`
- 可核查的关系候选：`[
  {
    "from": "lesson:08-06",
    "fromTitle": "二维平面上的回溯法 Word Search",
    "to": "lesson:08-07",
    "toTitle": "flood fill 算法，一类经典问题 Number of Islands",
  ...
  {
    "from": "lesson:06-05",
    "fromTitle": "BFS 和图的最短路径 Perfect Squares",
    "to": "lesson:08-07",
    "toTitle": "flood fill 算法，一类经典问题 Number of Islands",
    "type": "alternative_to",
    "status": "provisional",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-07"`；
- 所有时间戳不超过 `1287480`；
