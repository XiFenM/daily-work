...
- 课次 ID：`08-03`
- 章节：`08 递归和回溯法`
- 目录原始标题：`排列问题 Permutations`
- 目录规范标题：`排列问题 Permutations`
- 目录与 FFprobe 时长：`19:02（目录标称）；1142.12 秒（FFprobe）`
- **视频实测总时长：`1142.12` 秒，即 `1142120` 毫秒**
- 视频资产 ID：`asset:video-08-03`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-02",
    "title": "什么是回溯"
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-03"`；
- 所有时间戳不超过 `1142120`；
