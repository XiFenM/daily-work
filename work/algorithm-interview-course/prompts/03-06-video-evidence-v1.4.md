...
- 课次 ID：`03-06`
- 章节：`03 数组中的问题其实最常见`
- 目录原始标题：`对撞指针 Two Sum II - Input Array is Sorted`
- 目录规范标题：`对撞指针 Two Sum II - Input Array is Sorted`
- 目录与 FFprobe 时长：`19:44（目录标称）；1184.28 秒（FFprobe）`
- **视频实测总时长：`1184.28` 秒，即 `1184280` 毫秒**
- 视频资产 ID：`asset:video-03-06`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "03-05",
...
- 可核查的关系候选：`[
  {
    "from": "lesson:03-06",
    "fromTitle": "对撞指针 Two Sum II - Input Array is Sorted",
    "to": "lesson:04-04",
    "toTitle": "使用查找表的经典问题 Two Sum",
    "type": "contrasts_with",
    "status": "provisional",
  ...
  },
  {
    ...
    "fromTitle": "对撞指针 Two Sum II - Input Array is Sorted",
    "to": "lesson:05-06",
    "toTitle": "链表与双指针 Remove Nth Node Form End of List",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-03-06"`；
- 所有时间戳不超过 `1184280`；
