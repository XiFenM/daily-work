...
- 课次 ID：`09-08`
- 章节：`09 动态规划基础`
- 目录原始标题：`LIS问题 Longest Increasing Subsequence`
- 目录规范标题：`LIS 问题 Longest Increasing Subsequence`
- 目录与 FFprobe 时长：`25:12（目录标称）；1512.083447 秒（FFprobe）`
- **视频实测总时长：`1512.083447` 秒，即 `1512083` 毫秒**
- 视频资产 ID：`asset:video-09-08`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "09-07",
    "title": "面试中的 0-1 背包问题 Partition Equal Subset Sum"
  },
  {
    "lessonId": "09-09",
    "title": "LCS、最短路、求动态规划的具体解以及更多"
  }
]`
- 可核查的关系候选：`[
  {
    "from": "lesson:09-04",
    "fromTitle": "状态的定义和状态转移 House Robber",
    "to": "lesson:09-08",
    "toTitle": "LIS 问题 Longest Increasing Subsequence",
    "type": "applies",
    "status": "provisional",
...
"titleObserved": null,
"contentKind": "unknown",
"actualDurationSeconds": 1512.083447,
"timeline": [],
"learningObjectives": [],
"concepts": [],
"problem": null,
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-09-08"`；
- 所有时间戳不超过 `1512083`；
