...
- 课次 ID：`05-03`
- 章节：`05 在链表中穿针引线`
- 目录原始标题：`设立链表的虚拟头结点 Remove Linked List Elements`
- 目录规范标题：`设立链表的虚拟头结点 Remove Linked List Elements`
- 目录与 FFprobe 时长：`17:08（目录标称）；1028.8 秒（FFprobe）`
- **视频实测总时长：`1028.8` 秒，即 `1028800` 毫秒**
- 视频资产 ID：`asset:video-05-03`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "05-02",
    "title": "测试你的链表程序"
  ...
  {
    "lessonId": "05-04",
    "title": "复杂的穿针引线 Swap Nodes in Pairs"
  }
]`
- 可核查的关系候选：`[
  {
    "from": "lesson:05-01",
    "fromTitle": "链表，在节点间穿针引线 Reverse Linked List",
    "to": "lesson:05-03",
    "toTitle": "设立链表的虚拟头结点 Remove Linked List Elements",
  ...
  {
    "from": "lesson:05-03",
    "fromTitle": "设立链表的虚拟头结点 Remove Linked List Elements",
    "to": "lesson:05-04",
    "toTitle": "复杂的穿针引线 Swap Nodes in Pairs",
    "type": "extends",
    "status": "provisional",
    "priorKind": "non_evidence_candidate_for_checking"
  }
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-05-03"`；
- 所有时间戳不超过 `1028800`；
