...
- 目录原始标题：`结语`
- 目录规范标题：`结语`
- 目录与 FFprobe 时长：`02:45（目录标称）；169.88 秒（FFprobe）`
- **视频实测总时长：`169.88` 秒，即 `169880` 毫秒**
- 视频资产 ID：`asset:video-11-01`
- 相邻课次，仅用于定位：`无`
- 可核查的关系候选：`无`
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-11-01"`；
- 所有时间戳不超过 `169880`；
