...
- 目录原始标题：`运用栈模拟递归`
- 目录规范标题：`运用栈模拟递归`
- 目录与 FFprobe 时长：`19:33（目录标称）；1173.12 秒（FFprobe）`
- **视频实测总时长：`1173.12` 秒，即 `1173120` 毫秒**
- 视频资产 ID：`asset:video-06-03`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "06-02",
    "title": "栈和递归的紧密关系 Binary Tree Preorder, Inorder and Postorder Traversal"
  },
  {
    "lessonId": "06-04",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-06-03"`；
- 所有时间戳不超过 `1173120`；
