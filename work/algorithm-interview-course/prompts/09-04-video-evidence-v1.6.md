...
- 课次 ID：`09-04`
- 章节：`09 动态规划基础`
- 目录原始标题：`状态的定义和状态转移 House Robber`
- 目录规范标题：`状态的定义和状态转移 House Robber`
- 目录与 FFprobe 时长：`27:19（目录标称）；1639.12 秒（FFprobe）`
- **视频实测总时长：`1639.12` 秒，即 `1639120` 毫秒**
- 视频资产 ID：`asset:video-09-04`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "09-03",
    "title": "发现重叠子问题 Integer Break"
  },
  {
    "lessonId": "09-05",
    "title": "0-1 背包问题"
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-09-04"`；
- 所有时间戳不超过 `1639120`；
