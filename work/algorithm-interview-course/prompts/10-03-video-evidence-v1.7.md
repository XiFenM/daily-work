...
- 目录原始标题：`贪心选择性质的证明`
- 目录规范标题：`贪心选择性质的证明`
- 目录与 FFprobe 时长：`15:19（目录标称）；923.32 秒（FFprobe）`
- **视频实测总时长：`923.32` 秒，即 `923320` 毫秒**
- 视频资产 ID：`asset:video-10-03`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "10-02",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-10-03"`；
- 所有时间戳不超过 `923320`；
