...
- 课次 ID：`01-01`
- 章节：`01 算法面试到底是什么鬼?`
- 目录原始标题：`算法面试不仅仅是正确的回答问题最近学习`
- 目录规范标题：`算法面试不仅仅是正确的回答问题`
- 目录时长：`目录未知；1180.28 秒（FFprobe）`
- 视频资产 ID：`asset:video-01-01`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "01-02",
    "title": "算法面试只是面试的一部分"
...
- 允许检查的候选关联课：`[
  ...
  },
  {
    ...
    "type": "revisits",
    "status": "provisional",
    "rationale": "07-03 的配套文本重新讨论算法题表现与工程、用户价值之间的关系。"
  }
]`
