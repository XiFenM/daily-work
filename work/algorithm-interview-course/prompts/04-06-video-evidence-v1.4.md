...
- 课次 ID：`04-06`
- 章节：`04 查找表相关问题`
- 目录原始标题：`灵活选择键值 Number of Boomerangs`
- 目录规范标题：`灵活选择键值 Number of Boomerangs`
- 目录与 FFprobe 时长：`14:45（目录标称）；885.6 秒（FFprobe）`
- **视频实测总时长：`885.6` 秒，即 `885600` 毫秒**
- 视频资产 ID：`asset:video-04-06`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "04-05",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-04-06"`；
- 所有时间戳不超过 `885600`；
