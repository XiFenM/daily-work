...
- 课次 ID：`04-05`
- 章节：`04 查找表相关问题`
- 目录原始标题：`灵活选择键值 4Sum II`
- 目录规范标题：`灵活选择键值 4Sum II`
- 目录与 FFprobe 时长：`13:25（目录标称）；805.2 秒（FFprobe）`
- **视频实测总时长：`805.2` 秒，即 `805200` 毫秒**
- 视频资产 ID：`asset:video-04-05`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "04-04",
...
- 可核查的关系候选：`[
  ...
  {
    "from": "lesson:04-05",
    "fromTitle": "灵活选择键值 4Sum II",
    "to": "lesson:04-06",
    "toTitle": "灵活选择键值 Number of Boomerangs",
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-04-05"`；
- 所有时间戳不超过 `805200`；
