...
- 目录原始标题：`算法面试只是面试的一部分`
- 目录规范标题：`算法面试只是面试的一部分`
- 目录时长：`14:51（目录标称）；891.76 秒（FFprobe）`
- 视频资产 ID：`asset:video-01-02`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "01-01",
...
- 允许检查的候选关联课：`[
  {
    ...
    "type": "extends",
    "status": "provisional",
    "rationale": "从“算法面试不只是答对问题”扩展到算法面试在整体面试中的位置。"
  },
  {
    "from": "lesson:01-02",
    "to": "lesson:01-03",
    ...
    "status": "provisional",
    "rationale": "先理解算法面试的范围，再讨论系统准备方法。"
  },
  {
    "from": "lesson:07-03",
    "to": "lesson:01-02",
    "type": "revisits",
    "status": "provisional",
    "rationale": "07-03 的配套文本再次强调算法能力只是工程师面试评价的一部分。"
  }
]`
