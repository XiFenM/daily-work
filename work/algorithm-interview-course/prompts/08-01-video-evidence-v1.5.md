# Video Evidence Extraction Prompt v1.5
...
- 课次 ID：`08-01`
- 章节：`08 递归和回溯法`
- 目录原始标题：`树形问题 Letter Combinations of a Phone Number`
- 目录规范标题：`树形问题 Letter Combinations of a Phone Number`
- 目录与 FFprobe 时长：`18:09（目录标称）；1092.522086 秒（FFprobe）`
- **视频实测总时长：`1092.522086` 秒，即 `1092522` 毫秒**
- 视频资产 ID：`asset:video-08-01`
- 相邻课次，仅用于定位：`[
  {
    "lessonId": "08-02",
    "title": "什么是回溯"
...
- 可核查的关系候选：`[
  {
    "from": "lesson:07-07",
    "fromTitle": "二分搜索树中的问题 Lowest Common Ancestor of a Binary Search Tree",
    "to": "lesson:08-01",
    "toTitle": "树形问题 Letter Combinations of a Phone Number",
  ...
  {
    "from": "lesson:08-01",
    "fromTitle": "树形问题 Letter Combinations of a Phone Number",
    "to": "lesson:08-02",
    "toTitle": "什么是回溯",
    "type": "extends",
    "status": "provisional",
...
"titleObserved": null,
"contentKind": "unknown",
"actualDurationSeconds": 1092.522086,
"timeline": [],
"learningObjectives": [],
"concepts": [],
"problem": null,
...
"requestId": null,
"promptVersion": "video-evidence-v1.5",
"generatedAt": null
}
}
...
- 所有证据 ID 存在；
- 所有 evidence 使用 `assetId: "asset:video-08-01"`；
- 所有时间戳不超过 `1092522`；
